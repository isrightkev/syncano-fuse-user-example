...
const SlowBuffer = require('./syncano-js/dist/buffer').SlowBuffer;
const util = require('./syncano-js/dist/util');
const pathModule = require('./syncano-js/dist/path');

const binding = process.binding('fs');
const constants = require('./syncano-js/dist/constants');
const fs = exports;
const Buffer = require('./syncano-js/dist/buffer').Buffer;
const Stream = require('./syncano-js/dist/stream').Stream;
const EventEmitter = require('./syncano-js/dist/events');
...
const kMaxLength = require('./syncano-js/dist/buffer').kMaxLength;
